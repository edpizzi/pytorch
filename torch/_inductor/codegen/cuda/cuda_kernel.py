...
from ...ir import ComputedBuffer, IRNode, Pointwise, TemplateBuffer, TensorBox
...
class CUDATemplateBuffer(TemplateBuffer):
    ...
    def _merge_inputs(epilogue_nodes, template):
        ...
        template_input_id_set = {id(node) for node in template.input_nodes}
    ...
    def create_fused_buffer(self, node) -> "CUDATemplateBuffer":
        """
